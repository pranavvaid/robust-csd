...
class GeneralizedRCNN(nn.Module):
    ...
    def set_consistency_mode(self, consistency_mode):
        ...
        self.proposal_generator.set_consistency_mode(consistency_mode)
        self.roi_heads.set_consistency_mode(consistency_mode)
    ...
    def forward(self, batched_inputs: List[Dict[str, torch.Tensor]]):
        ...
        if self.consistency_mode:
            ...
            detector_results = GeneralizedRCNN._postprocess(detector_results, batched_inputs, images.image_sizes)
        else:
